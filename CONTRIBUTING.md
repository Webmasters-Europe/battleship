...
We accept contributions via Pull Requests on [Github](https://github.com/Webmasters-Europe/battleship).
...
3. Before you make any changes, keep your fork in sync to avoid merge conflicts:
    ...
    ```bash
    git remote add upstream https://github.com/Webmasters-Europe/battleship
